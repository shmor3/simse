...
simse-app/                # TypeScript — SaaS web app (React Router + Cloudflare Pages)
...
- **Rust-first architecture**: All core logic is in Rust. TS packages are application/service layers (simse-app, simse-api, simse-auth, simse-payments, simse-cdn, simse-landing, simse-mailer).
