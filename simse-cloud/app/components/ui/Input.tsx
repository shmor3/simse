		...
		<div className="space-y-1.5">
			...
			<div className="relative">
				...
				<input
					id={inputId}
					className={clsx(
						'w-full rounded-lg border bg-zinc-900 px-3 py-2.5 text-sm text-zinc-100 placeholder:text-zinc-600 transition-colors focus:border-emerald-400/50 focus:outline-none focus:ring-1 focus:ring-emerald-400/25',
						error
							? 'border-red-500/50'
