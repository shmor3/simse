...
describe('Files Commands E2E', () => {
	...
	// /files
	// -----------------------------------------------------------------
	it('/files lists virtual filesystem files', async () => {
	...
	// /files <path>
	// -----------------------------------------------------------------
	it('/files with path lists files in that path', async () => {
		term = await createSimseTerminal({ acpBackend: 'none' });
		await waitForReady(term);
	...
	// /save
	// -----------------------------------------------------------------
	it('/save saves VFS files to disk', async () => {
		term = await createSimseTerminal({ acpBackend: 'none' });
		await waitForReady(term);
	...
	// /validate
	// -----------------------------------------------------------------
	it('/validate validates VFS file contents', async () => {
		term = await createSimseTerminal({ acpBackend: 'none' });
		await waitForReady(term);
	...
	// /discard
	// -----------------------------------------------------------------
	it('/discard discards VFS changes', async () => {
		term = await createSimseTerminal({ acpBackend: 'none' });
		await waitForReady(term);
	...
	// /diff
	// -----------------------------------------------------------------
	it('/diff shows VFS file diffs', async () => {
		term = await createSimseTerminal({ acpBackend: 'none' });
		await waitForReady(term);
