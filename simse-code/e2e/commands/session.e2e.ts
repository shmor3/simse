...
describe('Session Commands E2E', () => {
	...
	// /mcp
	// -----------------------------------------------------------------
	it('/mcp shows MCP connection status', async () => {
	...
	// /acp
	// -----------------------------------------------------------------
	it('/acp shows ACP connection status', async () => {
		term = await createSimseTerminal({ acpBackend: 'none' });
		await waitForReady(term);
	...
	// /library
	// -----------------------------------------------------------------
	it('/library toggles library integration', async () => {
		term = await createSimseTerminal({ acpBackend: 'none' });
		await waitForReady(term);
	...
	// -----------------------------------------------------------------
	it('/memory is an alias for /library', async () => {
		term = await createSimseTerminal({ acpBackend: 'none' });
		await waitForReady(term);
	...
	// /bypass-permissions
	// -----------------------------------------------------------------
	it('/bypass-permissions toggles bypass mode', async () => {
		term = await createSimseTerminal({ acpBackend: 'none' });
		await waitForReady(term);
	...
	// /server
	// -----------------------------------------------------------------
	it('/server shows current server', async () => {
		term = await createSimseTerminal({ acpBackend: 'none' });
		await waitForReady(term);
