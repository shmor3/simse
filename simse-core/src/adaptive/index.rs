...
use crate::adaptive::vector_storage::VectorStorage;
...
/// our `crate::adaptive::distance::cosine_distance` which returns `1.0 - cosine_similarity`,
...
impl hnsw_rs::anndists::dist::distances::Distance<f32> for CosineDistanceAdapter {
	fn eval(&self, a: &[f32], b: &[f32]) -> f32 {
		crate::adaptive::distance::cosine_distance(a, b) as f32
	}
}
