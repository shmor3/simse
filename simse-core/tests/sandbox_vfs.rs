...
use simse_core::sandbox::vfs_disk::{DiskFs, DiskSearchMode, DiskSearchOptions, DiskSearchResult};
use simse_core::sandbox::vfs_path::VfsLimits;
use simse_core::sandbox::vfs_store::{SearchOpts, SearchOutput, TransactionOp, VirtualFs};
...
fn vfs_events_are_emitted() {
	use simse_core::sandbox::vfs_store::VfsEvent;
